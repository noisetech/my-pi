      ...
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block">
              <img src="{{ asset('backend/wopo 1.svg') }}" alt="" style="width: 22rem; padding-top: 100px; margin-left: 60px;">
          </div>
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4" style="font-family: Poppins; font-size: 16px; font-weight: 600;">Create an Account!</h1>
              </div>
